...
response = create_openai_completion(user_response_wrapper_prompt)
...
def generate_html_content(target_audience: str, stylistic_description: str, content_description: str, format: str) -> str:
